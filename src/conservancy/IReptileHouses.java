...
/**
 * IReptileHouses, implement a tracking system for many Reptile Houses which
 * house the reptiles and amphibians in a number of different habitats.
 *
 * <ul>
...
public interface IReptileHouses {
  /**
   * HabitatSize as 30 square meters. Note: Max Habitat size for any habitat will
   * be 30
   *
   */
   ...
   * species.
   * 
   * @param speciesName           Name of the species to be added to the reptile
   *                              house
   ...
   *                              is endangered or not. Note: throws
   *                              IllegalArgumentException if the input variables
   *                              are null
   ...
   *                    Note: throws IllegalArgumentException if the input
   *                    variables are null
   * @return a IReptileHouses object with result property as true, if its
   *         compatible otherwise false.
   */
   ...
   * 
   * @param speciesToLookUp Name of the species to be looked up in the reptile
   *                        house habitat(s) Note: throws IllegalArgumentException
   *                        if the input variables are null
   ...
   * species is housed in that habitat.
   * 
   * @param habitatName habitat's name for which sign has to be printed. Note:
   *                    throws IllegalArgumentException if the input variables are
   *                    null
